...
const u8 gText_QuestLog_LeftOaksLab[] = _("{PLAYER} left PROF. TREE's POKéMON\nRESEARCH LAB.");
...
const u8 gText_QuestLog_OakResearchLab[] = _("TREE RESEARCH LAB");
...
const u8 gText_QuestLog_SafariZone[] = _("WOBURN SAFARI PARK");
