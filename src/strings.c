...
const u8 gText_MenuQuestLog[] = _("QUEST LOG");
...
const u8 gText_OakForbidsUseOfItemHere[] = _("TREE: {PLAYER}!\nThis isn't the time to use that!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("TREE: It's important to get to know\nyour POKéMON thoroughly.\p");
...
const u8 gText_Lemonade_350[] = _("LIQUID DEATH{CLEAR_TO 0x57}{FONT_SMALL}¥350");
...
const u8 gText_Boulderbadge[] = _("PAVEMENTBADGE");
const u8 gText_Cascadebadge[] = _("POOLSIDEBADGE");
const u8 gText_Thunderbadge[] = _("BURNOUTBADGE");
const u8 gText_Rainbowbadge[] = _("EMPIREBADGE");
const u8 gText_Soulbadge[] = _("HUSTLERBADGE");
const u8 gText_Marshbadge[] = _("STARRIDERBADGE");
const u8 gText_Volcanobadge[] = _("DIABLOBADGE");
const u8 gText_Earthbadge[] = _("ADRENALINEBADGE");
...
const u8 gText_ProfOakSPc[] = _("PROF. TREE's PC");
...
const u8 gText_Lemonade[] = _("LIQUID DEATH");
...
const u8 gStartMenuDesc_QuestLog[] = _("Check your active quests and\nprogress in the region.");
...
const u8 gText_QuestLog_MainStory_Step2[] = _("Deliver the Special Edition Twilight\nBoxed Set to Professor Tree.");
const u8 gText_QuestLog_MainStory_Step3[] = _("Get the POKéDEX from Professor Tree\nand head to Pavement City.");
const u8 gText_QuestLog_MainStory_Step4[] = _("Defeat Faris at the Pavement City Gym\nto earn your first badge.");
const u8 gText_QuestLog_MainStory_Step5[] = _("Go through Mt. Moon and head to\nPoolside City.");
const u8 gText_QuestLog_MainStory_Step6[] = _("Defeat Bryony at the Poolside City Gym.");
const u8 gText_QuestLog_MainStory_Step7[] = _("Visit BILL at the Sea Cottage on\nRoute 25.");
const u8 gText_QuestLog_MainStory_Step8[] = _("Get the S.S. TICKET and head to\nBurnout City.");
const u8 gText_QuestLog_MainStory_Step9[] = _("Defeat LT. SURGE at the Burnout City\nGym.");
const u8 gText_QuestLog_MainStory_Step10[] = _("Get HM01 (CUT) from the S.S. ANNE\nCaptain.");
const u8 gText_QuestLog_MainStory_Step11[] = _("Go to Empire City and investigate the\nROCKET GAME CORNER.");
const u8 gText_QuestLog_MainStory_Step12[] = _("Defeat DAVID at the Empire City Gym.");
const u8 gText_QuestLog_MainStory_Step13[] = _("Rescue the SILPH CO. President in\nStarrider City.");
const u8 gText_QuestLog_MainStory_Step14[] = _("Defeat SABRINA at the Starrider City\nGym.");
const u8 gText_QuestLog_MainStory_Step15[] = _("Go to Hustler City through the\nCYCLING ROAD.");
const u8 gText_QuestLog_MainStory_Step16[] = _("Defeat KOGA at the Hustler City Gym.");
const u8 gText_QuestLog_MainStory_Step17[] = _("Explore the POKéMON MANSION on\nDiablo Island.");
const u8 gText_QuestLog_MainStory_Step18[] = _("Defeat BLAINE at Diablo Island Gym.");
const u8 gText_QuestLog_MainStory_Step19[] = _("Go to Adrenaline City for your final\nGym Challenge.");
const u8 gText_QuestLog_MainStory_Step20[] = _("Defeat the Final Gym Leader in\nAdrenaline City.");
const u8 gText_QuestLog_MainStory_Step21[] = _("Challenge the ELITE FOUR at the\nLibertine Plateau!");
const u8 gText_QuestLog_MainStory_Step22[] = _("Defeat LORELEI of the ELITE FOUR.");
const u8 gText_QuestLog_MainStory_Step23[] = _("Defeat BRUNO of the ELITE FOUR.");
const u8 gText_QuestLog_MainStory_Step24[] = _("Defeat JACQUIE of the ELITE FOUR.");
const u8 gText_QuestLog_MainStory_Step25[] = _("Defeat LANCE of the ELITE FOUR.");
...
const u8 gText_QuestLog_StaceyQuest_Step2[] = _("Stacey is at Diablo Island selling\nVolcano Insurance. Sounds legit.");
...
const u8 Text_FriendName_Steve[] = _("STEVE");
const u8 Text_FriendName_Fernanda[] = _("FERNANDA");
const u8 Text_FriendName_Sam[] = _("SAM");
...
const u8 Text_EeveeAdoption_GotParty[] = _("{PLAYER} adopted the EEVEE!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Debug_GiveMon[] = _("GIVEMON");
const u8 gText_Debug_Items[] = _("ITEMS");
const u8 gText_Debug_Flags[] = _("FLAGS");
const u8 gText_Debug_Warp[] = _("WARP");
const u8 gText_Debug_MillTown[] = _("CLEAR TOWN");
const u8 gText_Debug_PermTer[] = _("PAVEMENT");
const u8 gText_Debug_Plateau[] = _("LIBERTINE");
const u8 gText_Debug_Viridian[] = _("ADRENALINE");
const u8 gText_Debug_Pewter[] = _("PAVEMENT");
const u8 gText_Debug_Cerulean[] = _("POOLSIDE");
const u8 gText_Debug_Vermilion[] = _("BURNOUT");
const u8 gText_Debug_Lavender[] = _("MASQUERADE");
const u8 gText_Debug_Celadon[] = _("EMPIRE");
const u8 gText_Debug_Fuchsia[] = _("HUSTLER");
const u8 gText_Debug_Saffron[] = _("STARRIDER");
const u8 gText_Debug_Cinnabar[] = _("DIABLO");
const u8 gText_Debug_Badges[] = _("BADGES");
const u8 gText_Debug_Fly[] = _("FLY");
const u8 gText_Debug_Pokedex[] = _("POKEDEX");
...
ALIGNED(4) const u8 gString_PokemonFireRed_Staff[] = _("SHUKTI VERSION - 2026\nStaff");
...
const u8 gFameCheckerOakName[] = _("TREE");
...
const u8 gText_Debug_Cities1[] = _("CITIES 1");
const u8 gText_Debug_Cities2[] = _("CITIES 2");
