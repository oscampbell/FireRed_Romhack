...
const u8 gText_Debug_MillTown[] = _("MILL TOWN");
const u8 gText_Debug_PermTer[] = _("PERM-TER");
const u8 gText_Debug_Plateau[] = _("PLATEAU");
const u8 gText_Debug_Viridian[] = _("VIRIDIAN");
const u8 gText_Debug_Pewter[] = _("PEWTER");
const u8 gText_Debug_Cerulean[] = _("CERULEAN");
const u8 gText_Debug_Vermilion[] = _("VERMILION");
const u8 gText_Debug_Lavender[] = _("LAVENDER");
const u8 gText_Debug_Celadon[] = _("CELADON");
const u8 gText_Debug_Fuchsia[] = _("FUCHSIA");
const u8 gText_Debug_Saffron[] = _("SAFFRON");
const u8 gText_Debug_Cinnabar[] = _("CINNABAR");
