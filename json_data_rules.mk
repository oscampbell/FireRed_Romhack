...
AUTO_GEN_TARGETS += $(DATA_SRC_SUBDIR)/region_map/region_map_entries.c
$(DATA_SRC_SUBDIR)/region_map/region_map_entries.c: $(DATA_SRC_SUBDIR)/region_map/region_map_sections.json $(DATA_SRC_SUBDIR)/region_map/region_map_sections.c.txt
	$(JSONPROC) $^ $@

AUTO_GEN_TARGETS += include/region_map_names.h
include/region_map_names.h: $(DATA_SRC_SUBDIR)/region_map/region_map_sections.json $(DATA_SRC_SUBDIR)/region_map/region_map_sections.h.txt
	$(JSONPROC) $^ $@

$(C_BUILDDIR)/region_map.o: c_dep += include/region_map_names.h
