...
- **OBJ_EVENT_GFX_WOMAN_1** (Script: `PalletTown_EventScript_SignLady`)
  - Dialogue (PalletTown_Text_HmmIsThatRight): *"(Global/External Text: PalletTown_Text_HmmIsThatRight)"*
  - Dialogue (PalletTown_Text_OhLookLook): *"(Global/External Text: PalletTown_Text_OhLookLook)"*
  - Dialogue (call_if_eq): *"(Global/External Text: call_if_eq)"*
- **OBJ_EVENT_GFX_FAT_MAN** (Script: `PalletTown_EventScript_FatMan`)
  - Dialogue (PalletTown_Text_CanStoreItemsAndMonsInPC): *"Technology is incredible!  You can now store and recall items  and POKéMON as data via PC.$"*
...
- **OBJ_EVENT_GFX_LASS** (Script: `PalletTown_EventScript_Zaynab`)
  - Dialogue (PalletTown_Text_Zaynab): *"ZAYNAB: SHUKTI! It's terrible!  TEAM ROCKET stole FIG!  They took our favorite dog...  Please find her!$"*
- **OBJ_EVENT_GFX_WOMAN_2** (Script: `PalletTown_EventScript_Aliyah`)
  - Dialogue (PalletTown_Text_Aliyah): *"ALIYAH: I saw those ROCKET thugs  running towards VIRID-LAN CITY with a\l shiny dog in a cage!  That must have been FIG!$"*
**Interactables / Signs:**
- **Sign** (Script: `PalletTown_EventScript_OaksLabSign`)
  - Text (PalletTown_Text_OakPokemonResearchLab): *"OAK POKéMON RESEARCH LAB$"*
- **Sign** (Script: `PalletTown_EventScript_PlayersHouseSign`)
  - Text (PalletTown_Text_PlayersHouse): *"{PLAYER}'s house$"*
- **Sign** (Script: `PalletTown_EventScript_RivalsHouseSign`)
  - Text (PalletTown_Text_RivalsHouse): *"{RIVAL}'s house$"*
- **Sign** (Script: `PalletTown_EventScript_TownSign`)
  - Text (PalletTown_Text_TownSign): *"MILL TOWN  Shades of your journey await!$"*
- **Sign** (Script: `PalletTown_EventScript_TrainerTips`)
  - Text (PalletTown_Text_PressStartToOpenMenu): *"(Global/External Text: PalletTown_Text_PressStartToOpenMenu)"*
...
- **Sign** (Script: `PalletTown_PlayersHouse_1F_EventScript_TV`)
  - Text (PalletTown_PlayersHouse_1F_Text_OopsWrongSide): *"Oops, wrong side…$"*
#### PalletTown_PlayersHouse_2F
**Interactables / Signs:**
- **Sign** (Script: `PalletTown_PlayersHouse_2F_EventScript_NES`)
  - Text (PalletTown_PlayersHouse_2F_Text_PlayedWithNES): *"{PLAYER} played with the NES.  A message appears on the screen:  “I love you SHUKTI! Love, OLLIE.”  …Okay!  It's time to go!$"*
- **Sign** (Script: `PalletTown_PlayersHouse_2F_EventScript_PC`)
  - Text (Text_PlayerBootedUpPC): *"(Global/External Text: Text_PlayerBootedUpPC)"*
- **Sign** (Script: `PalletTown_PlayersHouse_2F_EventScript_Sign`)
  - Text (PalletTown_PlayersHouse_2F_Text_PressLRForHelp): *"It's a posted notice…  If you're confused, ask for HELP!  Press the L or R Button!$"*
#### PalletTown_ProfessorOaksLab
**NPCs:**
- **OBJ_EVENT_GFX_SCIENTIST** (Script: `PalletTown_ProfessorOaksLab_EventScript_Aide1`)
  - Dialogue (PalletTown_ProfessorOaksLab_Text_StudyAsOaksAide): *"I study POKéMON as PROF. TREE's  AIDE.$"*
- **OBJ_EVENT_GFX_WORKER_F** (Script: `PalletTown_ProfessorOaksLab_EventScript_Aide3`)
  - Dialogue (PalletTown_ProfessorOaksLab_Text_OakIsAuthorityOnMons): *"PROF. TREE may not look like much,  but he's the authority on POKéMON.  Many POKéMON TRAINERS hold him in  high regard.$"*
...
- **OBJ_EVENT_GFX_PROF_OAK** (Script: `PalletTown_ProfessorOaksLab_EventScript_ProfOak`)
  - Dialogue (PalletTown_ProfessorOaksLab_Text_OakWhichOneWillYouChoose): *"TREE: Now, {PLAYER}.  Inside those three POKé BALLS are  POKéMON.  Which one will you choose for  yourself?$"*
- **OBJ_EVENT_GFX_ITEM_BALL** (Script: `PalletTown_ProfessorOaksLab_EventScript_BulbasaurBall`)
  - Dialogue (PalletTown_ProfessorOaksLab_Text_ThoseArePokeBalls): *"Those are POKé BALLS.  They contain POKéMON!$"*
...
- **OBJ_EVENT_GFX_BLUE** (Script: `PalletTown_ProfessorOaksLab_EventScript_Rival`)
  - Dialogue (PalletTown_ProfessorOaksLab_Text_RivalGrampsIsntAround): *"{RIVAL}: What, it's only {PLAYER}?  Ugh, I'm already annoyed.  Where's the Professor? I have a  salon to run! Or I did... before\l everyone became redundant.$"*
- **OBJ_EVENT_GFX_POKEDEX** (Script: `PalletTown_ProfessorOaksLab_EventScript_Pokedex`)
  - Dialogue (PalletTown_ProfessorOaksLab_Text_BlankEncyclopedia): *"It's like an encyclopedia, but the  pages are blank.$"*
- **OBJ_EVENT_GFX_POKEDEX** (Script: `PalletTown_ProfessorOaksLab_EventScript_Pokedex`)
  - Dialogue (PalletTown_ProfessorOaksLab_Text_BlankEncyclopedia): *"It's like an encyclopedia, but the  pages are blank.$"*
**Interactables / Signs:**
- **Sign** (Script: `PalletTown_ProfessorOaksLab_EventScript_Computer`)
  - Text (PalletTown_ProfessorOaksLab_Text_EmailMessage): *"There's an e-mail message here.  …  Finally!  The ultimate TRAINERS of the\l POKéMON LEAGUE are ready to\l take on all comers!  Bring your best POKéMON and see  how you rate as a TRAINER!  POKéMON LEAGUE HQ  IN-DYE-GO PLATEAU  PROF. TREE, please visit us!  …$"*
- **Sign** (Script: `PalletTown_ProfessorOaksLab_EventScript_Computer`)
  - Text (PalletTown_ProfessorOaksLab_Text_EmailMessage): *"There's an e-mail message here.  …  Finally!  The ultimate TRAINERS of the\l POKéMON LEAGUE are ready to\l take on all comers!  Bring your best POKéMON and see  how you rate as a TRAINER!  POKéMON LEAGUE HQ  IN-DYE-GO PLATEAU  PROF. TREE, please visit us!  …$"*
- **Sign** (Script: `PalletTown_ProfessorOaksLab_EventScript_LeftSign`)
  - Text (PalletTown_ProfessorOaksLab_Text_PressStartToOpenMenu): *"Press START to open the MENU!$"*
- **Sign** (Script: `PalletTown_ProfessorOaksLab_EventScript_RightSign`)
  - Text (PalletTown_ProfessorOaksLab_Text_SaveOptionInMenu): *"The SAVE option is on the MENU.  Use it regularly.$"*
#### PalletTown_RivalsHouse
**NPCs:**
- **OBJ_EVENT_GFX_DAISY** (Script: `PalletTown_RivalsHouse_EventScript_Daisy`)
  - Dialogue (PalletTown_RivalsHouse_Text_HiBrothersAtLab): *"DAISY: Hi, {PLAYER}!  My brother, {RIVAL}, is out at  Grandpa's LAB.$"*
  - Dialogue (applymovement): *"(Global/External Text: applymovement)"*
- **OBJ_EVENT_GFX_TOWN_MAP** (Script: `PalletTown_RivalsHouse_EventScript_TownMap`)
  - Dialogue (PalletTown_RivalsHouse_Text_ItsBigMapOfKanto): *"It's a big map of the KANTO region.  Now this would be useful!$"*
**Interactables / Signs:**
- **Sign** (Script: `PalletTown_RivalsHouse_EventScript_Bookshelf`)
  - Text (PalletTown_RivalsHouse_Text_ShelvesCrammedFullOfBooks): *"The shelves are crammed full of  books on POKéMON.$"*
- **Sign** (Script: `PalletTown_RivalsHouse_EventScript_Bookshelf`)
  - Text (PalletTown_RivalsHouse_Text_ShelvesCrammedFullOfBooks): *"The shelves are crammed full of  books on POKéMON.$"*
- **Sign** (Script: `PalletTown_RivalsHouse_EventScript_Picture`)
  - Text (PalletTown_RivalsHouse_Text_LovelyAndSweetClefairy): *"“The lovely and sweet  CLEFAIRY”$"*
