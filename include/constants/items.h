...
enum __attribute__((packed)) Item
{
    ...
    ITEM_POO_BAG = 874,
    ITEM_TWILIGHT_CHAPTER_1 = 875,
    ITEM_TWILIGHT_CHAPTER_2 = 876,
    ITEM_TWILIGHT_CHAPTER_3 = 877,
    ITEM_TWILIGHT_CHAPTER_4 = 878,
    ITEM_FIGS_TREATS = 879,
    ITEM_SHINY_FUR_CLUMP = 880,
    ITEM_PROTEIN_BAR = 881,
